...
Students were expected to learn how to build a finger table and how to keep data stored in the right nodes, as well as keeping the nodes in properly stabilized overlay network.
